//! Protocol Buffers which describe the structure of placer's pack format

#![allow(dead_code)]

/// Encrypted + signed packs of files
pub mod pack {
    include!(concat!(env!("OUT_DIR"), "/placer.pack.rs"));
}
...
pub mod timestamp {
    ...
    include!(concat!(env!("OUT_DIR"), "/placer.timestamp.rs"));
